...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  draw(context) {
	    ...
	    background.src = 'https://res.cloudinary.com/dfmvfna21/image/upload/v1479224549/maxresdefault_lpdks4.jpg';
	  ...
	  step(time) {
	    ...
	    document.getElementById('top-score').innerHTML = `Top Score: ${this.topScore}`;
